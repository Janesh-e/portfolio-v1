...
const Projects = () => {
  ...
  const scroll = (direction: 'left' | 'right') => {
    ...
    const scrollAmount = 400; // Width of one project card plus gap
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative">
          ...
          <button
            ...
            className={`absolute left-0 top-1/2 -translate-y-1/2 z-10 w-12 h-12 rounded-full border-2 border-emerald-500/50 backdrop-blur-sm flex items-center justify-center transition-all duration-300 ${
              canScrollLeft 
          ...
          <button
            ...
            className={`absolute right-0 top-1/2 -translate-y-1/2 z-10 w-12 h-12 rounded-full border-2 border-emerald-500/50 backdrop-blur-sm flex items-center justify-center transition-all duration-300 ${
              canScrollRight 
                ? 'bg-emerald-500/20 text-emerald-400 hover:bg-emerald-500/30 hover:border-emerald-400' 
                : 'bg-gray-800/50 text-gray-600 border-gray-600/50 cursor-not-allowed'
            }`}
